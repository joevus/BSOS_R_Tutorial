...
Before analyzing any data set, there has to be some prior work done in order to access the appropriate amount of information from the dataset. Most often. we require to access a single column or a few columns together from a large dataset, and not the entire dataset. In such scenarios, we should be able to know how to extract the pertinent information from out data. Hence, in this module, we will learn some basic data set operations. 

## Section One : Extracting Rows and Columns

This section talks about how to extract rows or/and columns from a data set.
...
<div id = "question1-hint">
**Hint :** In case you need to revisit the materials, refer to the subsection 'Extracting Specific Variables'.
</div>
...
<div id = "question2-hint">
**Hint :** In case you need to revisit the materials, refer to the subsection 'Selecting specific variables and rows in a dataset'.
</div>
###

## Section Two : Extracting & Building Vectors / Dataframes

This section is mainly focused on how to build your own vectors or data frame while working with a large dataset.
...
<div id= "q5-hint">
**Hint:** Refer to 'Other Logical Operators-- Equal to/Not equal to' for a refresher!
</div>
...
<div id= "q6-hint">
**Hint:** Refer to 'Other Logical Operators--AND' for help!
</div>
...
<div id= "q7-hint">
**Hint:** Just think about the command you would write to check the length of a vector; the vector is already there in the previous question!
</div>
...
<form id="completionForm">
  ...
  <input type="hidden" id="tutorial_id" name="tutorial_id" value="3">
