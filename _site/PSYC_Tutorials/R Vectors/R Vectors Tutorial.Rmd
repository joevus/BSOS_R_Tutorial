...
Welcome to learning R! As scary that might sound, once you go through this module, it will help you understand what R is, how to use it and what can be done using R. So, let's begin!
...
![Figure 1: The RStudio environment](../images_folder/rstudio_env.jpg){#id .class width=700 height=445px}

## What is a Code Block?

Below is a picture of code block in R markdown.

![Figure2: Code Block](../images_folder/code_block.jpg)
...
2. Use R to find the sum of squares of 1st five natural numbers.

```{r exercise2, exercise=TRUE}
```

<div id= "exercise2-hint-1">
*Hint:* Remember the natural numbers start from 1!
</div>

<div id= "exercise2-hint-2">
*Hint:* This is a two step process to think about. First take the squares and then sum them up!
</div>
