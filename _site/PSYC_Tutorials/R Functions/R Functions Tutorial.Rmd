...
Excel.dat.orginal <- read_xlsx("../data_psych/STAT200_Data_Update_4.8_original.xlsx")
...
```{r echo=TRUE,eval=FALSE}
CSV.dat.orginal <- read.csv("../data_psych/STAT200_Data_Update_4.8_original.csv")
...
1. Use the survey data set you loaded before, `survey` and write the code for finding out the summary of `height` of students.

```{r ex1, exercise=TRUE, echo = -1}
library(psych)

```

<div id = "ex1-hint">
**Hint:** Refer to the "More Dataset Functions" section for help. Think about the way you can access a specific column from the data set. 
</div>

2. How will you modify the code in question 1 to find the summary of `height` of the students for males and females?
...
<div id = "ex2-hint">
**Hint:** Refer to the "More Dataset Functions" section for help, and look through the given code to find the appropriate function.
</div>
...
<form id="completionForm">
  ...
  <input type="hidden" id="tutorial_id" name="tutorial_id" value="2">
