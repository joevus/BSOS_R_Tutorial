...
**Hint:** Not sure how to do it? No worries, refer back to "Using 'aov()' subsection"!
</div>
...
**Hint:** Remember how we included interaction in a model? What should we use on the right hand side, + or * ?
</div>
