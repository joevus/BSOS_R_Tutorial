...
```{r}
data.original1 <- read_xlsx("../data_psych/STAT200_Data_Update_4.8_original.xlsx")
...
```{r}
#Taking a quick look at how the data looks like
head(data.working)
...
#Running the Code
describeBy(data.working, data.working$Stat.Anxiety_Name)
  #describe(dataset, dataset$group)
```

*Note 1:* For more information on `describe.by()`, refer to this [link](https://www.rdocumentation.org/packages/psych/versions/2.0.12/topics/describeBy) . 

*Note 2:* Sometimes while working on your own R environment, you might see a warning like the following when you use describe.by();
"Warning: describe.by is deprecated.  Please use the describeBy function".
Not to worry, just use the later version!
...
Before moving on to the new section, here is a quick review exercise for you!

### Review Exercise

1. Choose the correct option.

```{r review1-question, echo=FALSE}
learnr::question("Which of the following options will be the best way to filter out the scores of the students who took the exam on paper?",
         answer("data.working$Note_Type_T1==1", correct=FALSE, message = "Be careful about the subsetting"),
         answer("data.working$Scores[data.working$Note_Type_Name == 'paper']", correct = TRUE,  message = "Good job!"),
         answer("data.working[data.working$Note_Type_Name == 'paper'& data.working$Scores]",  correct = FALSE, message = "Look closely at what we are trying to measure."),
         allow_retry = TRUE,
         random_answer_order = TRUE
)
```

2. Suppose you are asked to report the difference in average scores between students who had motivation more than 5 and had low anxiety and the students who had motivation less than or equal to 5 and had high anxiety.

```{r review2-question, echo=FALSE}
learnr::question("Identify the correct piece of code to perform the task in the question.",
         answer("data.working$Scores[data.working$Motivation >5 & data.working$Stat.Anxiety  == 1] - data.working$Scores[data.working$Motivation <=5 & data.working$Stat.Anxiety  == 3] ", correct=FALSE, message = "We want the difference in average!"),
         answer("mean(data.working$Scores[data.working$Motivation >5 & data.working$Stat.Anxiety  == 1]) - mean(data.working$Scores[data.working$Motivation <=5 & data.working$Stat.Anxiety  == 3])", correct = TRUE,  message = "Good job!"),
         answer("data.working$Scores[data.working$Motivation <=5 & data.working$Stat.Anxiety  == 1] - data.working$Scores[data.working$Motivation >5 & data.working$Stat.Anxiety  == 3]",  correct = FALSE, message = "uh-oh!look carefully at the condition for subsetting."),
         allow_retry = TRUE,
         random_answer_order = TRUE
)
```
...
**Note:** If you feel stuck at any exercise and need some help, click on the 'hint' button for help!
...
**Hint:** Refer to the section "casewise deletion" if you need some help!
</div>
...
**Hint:** Refer to "Doing Median Imputation" for help, if needed!
</div>

```{r exercise2-solution, echo=FALSE, exercise.reveal_solution = FALSE}
...
**Hint:** Check "Listwise deletion" if a little help is required!
</div>
...
Complete this form and submit it to record your completion of this tutorial.<br><br>
...
<form id="completionForm">
  ...
  <input type="text" id="uid" name="uid" value="123"><br><br>
  <input type="hidden" id="tutorial_id" name="tutorial_id" value="1">
...
<script>
  ...
  form.onsubmit = function(event){
    ...
    //open the request
    xhr.open('POST','http://completions.joehoskisson.com/completions')
